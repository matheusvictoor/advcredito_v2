  ...
  return (
    <div className={cn("flex w-full flex-col gap-4", className)} {...other}>
      ...
      <p className="text-sm text-muted-foreground lg:text-base">
        Só precisamos de algumas informações básicas para configurar sua
        organização. Você poderá editar isso mais tarde.
      </p>
      <div className="space-y-2">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex flex-col space-y-1">
            <span className="text-sm">Carregue seu logotipo</span>
        ...
        render={({ field }) => (
          <FormItem className="flex flex-row items-center justify-between">
            <div className="space-y-0.5">
              <FormLabel>Exemplo de dados</FormLabel>
              <FormDescription>
                Recomendado para explorar o sistema e entender como funciona.
              </FormDescription>
            </div>
            <FormControl>
              <Switch

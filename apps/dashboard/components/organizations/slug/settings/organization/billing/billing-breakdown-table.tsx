    ...
    <Table className={cn("w-full", className)} {...other}>
      ...
      <TableBody>
        {lineItems.map((item, index) => (
          <TableRow key={index} className="border-b hover:bg-inherit">
        ...
        {taxes?.map((tax, index) => (
          <TableRow key={`tax-${index}`} className="hover:bg-inherit">
            <TableCell colSpan={3} className="pl-8 text-muted-foreground">
              Tax
              <Tooltip delayDuration={0}>
                <TooltipTrigger asChild>
                  <InfoIcon className="ml-2 inline size-3.5 shrink-0 text-muted-foreground" />
                </TooltipTrigger>
        ...
        <TableRow className="border-t hover:bg-inherit">
          <TableCell colSpan={3}>
            ...
            <Tooltip delayDuration={0}>
              <TooltipTrigger asChild>
                <InfoIcon className="inline size-3.5 shrink-0 text-muted-foreground" />
              </TooltipTrigger>
              <TooltipContent className="max-w-[450px]">
